...
- FROM: `### Requirement: Index Arp Maps Monodromy to the Choice Argument`
- TO: `### Requirement: Index Arp Maps Gate-Step Indices to the Choice Argument`
- FROM: `### Requirement: Configuration Latching on Input Transitions`
- TO: `### Requirement: Configuration Latching on Input Ticks`
